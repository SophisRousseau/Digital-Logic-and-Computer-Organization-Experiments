...
synth_design -top ElectronicClock -part xc7a100tcsg324-1
...
write_checkpoint -force -noxdef ElectronicClock.dcp
OPTRACE "write_checkpoint" END { }
OPTRACE "synth reports" START { REPORT }
create_report "synth_1_synth_report_utilization_0" "report_utilization -file ElectronicClock_utilization_synth.rpt -pb ElectronicClock_utilization_synth.pb"
